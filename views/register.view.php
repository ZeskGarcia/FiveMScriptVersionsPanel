<html lang="<?= $config['userLang']; ?>">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title><?= $lang['registerPageTitle']; ?> - <?= $config['siteName']; ?></title>
  ...
  <body>
    ...
    <form class="login" method="POST" action="">
      ...
      <!-- Login Submit Button -->
      <button type="submit" submit><?= $lang['registerNow']; ?></button>

      <?php if ($config['allowRegistrations']) { ?>

        <!-- Registration reminder text -->
        <p style="text-align: center;"><?= $lang['havingAnAccount']; ?>&nbsp;<a href="/<?= $config['paths']['login']; ?>"><?= $lang['loginNow']; ?></a></p>
